...
class Configurar extends Component {
    ...
    savePreguntaId = async (id) => {
        await this.setState({preguntaId: id})
    }
                    ...
                    (<div style={{animation: `pop-in ${easings.easeOutExpo} 1000ms forwards`}}>
                                    ...
                                    <div className="preguntas-cont scroll">
                                        {
                                            this.state.preguntas.map((pregunta, index) => {
                                                if (pregunta.Id) {
                                                    return (
                                                        <div key={pregunta.Id}
                                                             className="pregunta-cont center-all flex-column mb-5">
                                ...
                                <div className="card-body center-all flex-column">
                                    ...
                                    <div className="select-box respuesta-correcta-select w-100 mt-15">
                                        <div className="select-box__current" tabIndex="1">
                                            ...
                                            <div className="select-box__value">
                                                <input className="select-box__input" type="radio" id="0" name="Inp"
                                                       defaultChecked
                                                       readOnly disabled/>
                                                <p className="select-box__input-text">Respuesta correcta</p>
                                            </div>
                                            <img className="select-box__icon" src={arrow} alt="Arrow"
                                                 aria-hidden="true"/>
                                        </div>
                                        <ul className="select-box__list scroll">
                                            <li>
                                                <label className="select-box__option" id="A"
                                                       onClick={this.onClickCorrecta}
                                                       htmlFor="A">
                                                    {this.state.quiz ? "A" : "Verdadero"}
                                                </label>
                                            </li>
                                            <li>
                                                <label className="select-box__option" id="B"
                                                       onClick={this.onClickCorrecta}
                                                       htmlFor="B">
                            ...
                            <div className="main-card-crear">
                                <div className="card-body">
                                    <div className="center-all mb-20 flex-column">
                                        <DragAndDropFileUploader tipo="PREGUNTA"
                                                                 afterSuccess={this.loadPreguntaActualizada}
                                                                 tipoId={this.state.preguntaId ? this.state.preguntaId : null}/>
                        ...
                        <div className="d-flex jc-center">
                            <button className="rounded-button success link center-all fin w-30"
                                    onClick={this.handleEmpezar}>Finalizar configuracion
                            </button>
                        </div>
                    </div>)}
