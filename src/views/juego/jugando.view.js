                        ...
                        <div className="card-body">
                            ...
                            <div>
                                <div className="arriba mb-10">
                                    <button className="rounded-button error mr-20">A - Maria</button>
                                    <button className="rounded-button success">B - Bonfrisco</button>
                                </div>
                                <div className="mb-10">
                                    <button className="rounded-button gold mr-20">C - Roberta</button>
                                    <button className="rounded-button purple">D - Gualberto</button>
                                </div>
                                {/*<div>
